...
public class MyDC {
	...
	public static class MyMapper extends Mapper<LongWritable,Text, Text, Text> {
		...
		protected void setup(Context context) throws java.io.IOException, InterruptedException{
		    ...
		    Path p1 = new Path(files[1].toString());
  ...
  public static void main(String[] args) 
    ...
    try
    {
    	DistributedCache.addCacheFile(new URI("salary.txt"),job.getConfiguration());
    	DistributedCache.addCacheFile(new URI("desig.txt"),job.getConfiguration());
    }
    catch(Exception ex)
    {
